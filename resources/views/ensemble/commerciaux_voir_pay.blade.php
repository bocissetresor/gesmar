                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                <thead>
                                                    <tr>
                                                      ...
                                                      <th scope="col">Tel</th>
                                                      <th scope="col" style="text-align: center;">Somme actuelle</th>
                                                      <th scope="col" style="text-align: center;">Voir historique</th>
                                                  </tr>
                                              </thead>
                                              <tbody>
                                              @foreach($commerciauxs as $commerciaux)
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>{{ $commerciaux->tel }}</td>
                                                        ...
                                                        <td style="text-align: center;"><strong><h3>{{ $commerciaux->som_actu }} XOF</h3></strong></td>
