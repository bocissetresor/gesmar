                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    @if ($ordonnacement_cie->statut==0)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $ordonnacement_cie->date_ordonnacement }}</td>
                                            <td>{{ $compteurCie->mois_payer }}</td>
                                            {{-- <td><a href="{{ url('paiement_index_cie', ['id' => $compteurCie->id]) }}">Regler</a></td> --}}

                                            @if ($ordonnacement_cie->date_ordonnacement < date('Y-m-d'))
                                                    <td style="text-align: center;"><a href="{{ url('paiement_index_cie', ['id' => $compteurCie->id]) }}" class="btn btn-success btn-xs"><i class="fa fa-money"></i>Regler</a></td>
