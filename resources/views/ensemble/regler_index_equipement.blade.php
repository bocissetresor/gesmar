        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                ...
                <div class="card" style="width: 150%; left: -20%">
                    ...
                    <form action="{{ url('regler_index_equipement_payer/'. $proprietes->id) }}" method="POST">
                        @csrf
                        <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="date" name="mois_payer" value="{{ $proprietes->mois_payer }}" required></td>
                                    <td><input type="number" class="form-control variable-field " name="index_dbt" min="{{ 1-1 }}" value="{{ $proprietes->index_dbt }}" required/></td>
                                    <td><input type="number" class="form-control variable-field " name="index_fn" min="{{ 1-1 }}" value="{{ $proprietes->index_fn }}" required/></td>
                                </tr>
