    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Ordonnancement de SODECI</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                    <form action="{{ url('ordonnacement_sodeci_page_post/'. $compteurSodecis->id) }}" method="POST">
                        @csrf
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Code Compteur Sodeci:<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" class='optional' name="" data-validate-length-range="5,15" type="text" value="{{ $compteurSodecis->code }}" readonly /></div>
                        </div>
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Code Contrat :<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                                {{-- @foreach ($compteurSodecis->Compteur_Sodecis as $Compteur_Sodeci) --}}
                                <input class="form-control" class='optional' name="" data-validate-length-range="5,15" type="text" value="{{ $compteurSodecis->code }}" readonly /></div>
                                {{-- @endforeach --}}
                        </div>
                            ...
                            <div class="input_fields_wrap" style="width:100%; width: 400px;margin: auto; ">
                                ...
                                <input type="number" class="form-control mb-3" name="somme_ordonnacement[]" min="{{ $compteurSodecis->index_fn-$compteurSodecis->index_fn+1 }}" max="{{ ($compteurSodecis->index_fn - $compteurSodecis->index_dbt)*1022 }}" required>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control variable-field quantity" value="{{ (($compteurSodecis->index_fn - $compteurSodecis->index_dbt)*1022 + $compteurSodecis->somme_restant) }}" id="total" readonly /></td>
