        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form method="POST" action="{{ url('creat_zone/'. $etages->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Nom Etage:<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control"  class='optional' name="etages_id" data-validate-length-range="5,15" type="text" value="{{ $etages->designation }}" disabled/></div>
                                </div>
