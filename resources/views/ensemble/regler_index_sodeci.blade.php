        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <form action="{{ url('regler_index_sodeci_payer/'. $compteurSodecis->id) }}" method="POST">
                        @csrf
                        <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="date" name="mois_payer" value="{{ $compteurSodecis->mois_payer }}" required></td>
                                    <td><input type="number" class="form-control variable-field " name="index_dbt" min="{{ 1-1 }}" value="{{ $compteurSodecis->index_dbt }}" required/></td>
                                    <td><input type="number" class="form-control variable-field " name="index_fn" min="{{ 1-1 }}" value="{{ $compteurSodecis->index_fn }}" required/></td>
