        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                ...
                <div class="card" style="width: 150%; left: -20%">
                    ...
                    <form action="{{ url('regler_index_gaz_payer/'. $gazs->id) }}" method="POST">
                        @csrf
                        <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="date" name="mois_payer" value="{{ $gazs->mois_payer }}" required></td>
                                    <td><input type="number" class="form-control variable-field" min="{{ 1-1 }}" name="index_dbt" value="{{ $gazs->index_dbt }}" required/></td>
                                    <td><input type="number" class="form-control variable-field" min="{{ 1-1 }}" name="index_fn" value="{{ $gazs->index_fn }}" required/></td>
