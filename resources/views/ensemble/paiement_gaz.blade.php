                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                  ...
                                  <tbody>
                                  @foreach($gazs as $gaz)
                                  @foreach ($gaz->ordonnacement_gazs as $ordonnacement_gaz)
                                  @if ($ordonnacement_gaz->statut==0)
                                <tr>
                                          <td>{{ $gaz->code }}</td>
                                          ...
                                          {{-- <td><a href="{{ url('paiement_index_gaz', ['id' => $gaz->id]) }}">Regler</a></td> --}}

                                          @if ($ordonnacement_gaz->date_ordonnacement < date('Y-m-d'))
                                                  <td style="text-align: center;"><a href="{{ url('paiement_index_gaz', ['id' => $gaz->id]) }}" class="btn btn-success btn-xs"><i class="fa fa-money"></i>Regler</a></td>
