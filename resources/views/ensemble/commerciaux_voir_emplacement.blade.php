                                    ...
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                ...
                                                @if($emplacement->commerciaux_id == $commercio_id)
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if($emplacement->paiement_journalier==1)
                                                        ...
                                                        <td><a href="{{ url('commerciaux_voir_emplacement_pay', ['id' => $emplacement->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-money"></i></a></td>
