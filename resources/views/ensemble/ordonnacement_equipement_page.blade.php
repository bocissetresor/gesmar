    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Ordonnancement d'Equipement</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                    <form action="{{ url('ordonnacement_equipement_page_post/'. $proprietes->id) }}" method="POST">
                        @csrf
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Code Compteur Equipement:<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" class='optional' name="" data-validate-length-range="5,15" type="text" value="{{ $proprietes->code }}" readonly /></div>
                        </div>
                            <hr>
                            ...
                            <div class="input_fields_wrap" style="width:100%; width: 400px;margin: auto; ">
                                ...
                                <input type="number" class="form-control mb-3" name="somme_ordonnacement[]" min="{{ $proprietes->index_fn-$proprietes->index_fn+1 }}" max="{{ ($proprietes->index_fn - $proprietes->index_dbt)*1022 }}" required>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control variable-field quantity" value="{{ (($proprietes->index_fn - $proprietes->index_dbt)*1022 + $proprietes->somme_restant) }}" id="total" readonly /></td>
