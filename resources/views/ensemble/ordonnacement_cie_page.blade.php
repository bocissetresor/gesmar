        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                    <form action="{{ url('ordonnacement_cie_page_post/'. $compteurCies->id) }}" method="POST">
                        @csrf
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Code Compteur Cie:<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" class='optional' name="" data-validate-length-range="5,15" type="text" value="{{ $compteurCies->code }}" readonly /></div>
                        </div>
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Code Contrat :<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                                {{-- @foreach ($compteurCies->Compteur_Cies as $compteurCies->Compteur_Cie) --}}
                                <input class="form-control" class='optional' name="" data-validate-length-range="5,15" type="text" value="{{ $compteurCies->code }}" readonly /></div>
                                {{-- @endforeach --}}
                        </div>
                            ...
                            <div class="input_fields_wrap" style="width:100%; width: 400px;margin: auto; ">
                                ...
                                <input type="number" class="form-control mb-3" name="somme_ordonnacement[]" min="{{ $compteurCies->index_fn-$compteurCies->index_fn+1 }}" max="{{ ($compteurCies->index_fn - $compteurCies->index_dbt)*1022 }}" required>
                            </div>
                            <hr>
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="date" name="mois_payer" value="{{ $compteurCies->mois_payer }}" readonly></td>
                                    ...
                                    <td><input type="number" class="form-control variable-field quantity" value="{{ (($compteurCies->index_fn - $compteurCies->index_dbt)*1022 + $compteurCies->somme_restant) }}" id="total" readonly /></td>
