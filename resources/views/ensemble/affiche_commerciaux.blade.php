                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                <thead>
                                                    <tr>
                                                      ...
                                                      <th scope="col">Attribuer Emplacement</th>
                                                      <th scope="col">Générer Bordereaux </th>
                                              ...
                                              @foreach($commerciauxs as $commerciaux)
                                                  ...
                                                  <tr>
                                                      ...
                                                      @if($commerciaux->statut==1)
                                                        ...
                                                        @endif
                                                      <td style="text-align: center;"><a href="{{ url('affiche_box', ['id' => $commerciaux->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-gears"></i> Attribuer</a></td>
                                                      <td style="text-align: center;"><a href="{{ url('generer_bordereaux', ['id' => $commerciaux->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-refresh"></i> Générer</a></td>
                                                      <td style="text-align: center;"><a href="{{ url('edit_commerciaux', ['id' => $commerciaux->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edite</a></td>
                                                      <td style="text-align: center;"><a href="{{ url('supprimer_commerciaux', ['id' => $commerciaux->id]) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Supprime</a></td>
                                                  </tr>
                                              @endforeach
                                            </tbody>
                                          </table>
